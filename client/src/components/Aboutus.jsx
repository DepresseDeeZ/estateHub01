      ...
      <div className="flex flex-col xl:flex-row gap-10">
        ...
        <div className="flex-1 flex justify-center flex-col">
          ...
          <p className="py-5">
            ...
            ullam sed minima vitae laboriosam doloremque et eligendi dolore est
            quis? Excepturi hic sapiente voluptatum voluptates aspernatur
            tempora voluptas quas repudiandae rerum. Saepe repellat molestiae
            nostrum praesentium hic, impedit quibusdam officia aspernatur sint
            doloremque mollitia commodi in repudiandae, quaerat quasi a
            obcaecati similique.
          </p>
